  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<AppSettingRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AppSettingRecord> checkupAppSettingRecordList = snapshot.data!;
        final checkupAppSettingRecord = checkupAppSettingRecordList.isNotEmpty
            ? checkupAppSettingRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
