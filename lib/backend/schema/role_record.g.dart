...
class _$RoleRecord extends RoleRecord {
  ...
  _$RoleRecord._({this.name, this.ffRef}) : super._();
  ...
  bool operator ==(Object other) {
    ...
    return other is RoleRecord && name == other.name && ffRef == other.ffRef;
  }
...
class RoleRecordBuilder implements Builder<RoleRecord, RoleRecordBuilder> {
  ...
  _$RoleRecord _build() {
    final _$result = _$v ?? new _$RoleRecord._(name: name, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
